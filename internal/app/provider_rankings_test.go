...
func TestRankingHandlerRegistersPlayableMetadataOnce(t *testing.T) {
	...
	a := &UIApp{downloader: d, cfg: d.cfg, dramas: []Drama{{ID: "hongguo:7681903520873729048", Source: sourceHongguo, Title: "旧标题", OnlineDate: "2026-09-01"}, {ID: "hongguo:7000000000000000009", Source: sourceHongguo, Title: "保留既有红果剧集"}}}
